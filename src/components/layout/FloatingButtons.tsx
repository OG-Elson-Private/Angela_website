  ...
  return (
    ...
    >
      ...
      <a
        ...
        className="group flex items-center justify-center w-14 h-14 bg-[#25D366] rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200"
      ...
      >
        ...
        {/* Tooltip */}
        <span className="absolute right-full mr-3 px-3 py-1.5 bg-charcoal text-white text-sm font-ui rounded-lg opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap">
          Chat on WhatsApp
        </span>
      </a>
