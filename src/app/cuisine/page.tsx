        ...
        <div className="relative container-standard text-center text-white px-4">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-ocean-dark" asChild>
              <a href="https://wa.me/254719635944" target="_blank" rel="noopener noreferrer">
                Contact on WhatsApp
              </a>
            </Button>
          </div>
      ...
      <section id="chef-prive" className="section-padding bg-seafoam">
        <div className="container-standard">
          ...
          <div className="text-center">
            <Button variant="gradient" size="lg" asChild>
              <a href="https://wa.me/254719635944?text=Hello%20Chef%20Angie!%20I'm%20interested%20in%20your%20private%20chef%20service.%20Date:%20____%20Number%20of%20guests:%20____%20Occasion:%20____" target="_blank" rel="noopener noreferrer">
                Book Private Chef
              </a>
            </Button>
          </div>
      ...
      <section id="traiteur" className="section-padding bg-white">
        <div className="container-standard">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <Button variant="gradient" size="lg" asChild>
              <a href="https://wa.me/254719635944?text=Hello%20Chef%20Angie!%20I'm%20interested%20in%20catering%20for%20an%20event.%20Event%20type:%20____%20Date:%20____%20Number%20of%20guests:%20____" target="_blank" rel="noopener noreferrer">
                Request a Quote
              </a>
            </Button>
          </div>
